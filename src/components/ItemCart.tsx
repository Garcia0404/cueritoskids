        ...
        <div className="flex flex-col flex-1">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="cursor-pointer" onClick={() => removeFromCart(product)}>
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 stroke-red-500">
